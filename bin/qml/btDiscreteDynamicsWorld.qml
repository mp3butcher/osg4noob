...
Column{
    ...
    y:50
    id: obj
    objectName: "btDiscreteDynamicsWorldQQQ"
   property var btDiscreteDynamicsWorld
...
//          height: childrenRect.height
    ...
    TextField {
        ...
        text: obj.btDiscreteDynamicsWorld.Language


        onTextChanged: {
            if( obj.btDiscreteDynamicsWorld.Language != text )
            obj.btDiscreteDynamicsWorld.Language = text
        }
    }
}
