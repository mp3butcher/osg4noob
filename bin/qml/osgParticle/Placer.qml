...
y:75
                id: obj
                objectName: "osgParticle_PlacerQQQ"
                property var osgParticle_Placer
                //QQModel
     ...
     //     width: childrenRect.width
      //          height: childrenRect.height
                    ...
                    Row {
                        TextField {
                            text: obj.osgParticle_Placer.controlPosition.x.toFixed(
                                      1)
                        }
                        TextField {
                            text: obj.osgParticle_Placer.controlPosition.y.toFixed(
                                      1)
                        }
                        TextField {
                            text: obj.osgParticle_Placer.controlPosition.z.toFixed(
                                      1)
                        }
                    }
                    ...
                    Label {
                        ...
                        TextField {
                            text: obj.osgParticle_Placer.volume.toFixed(
                                      1)
                        }
