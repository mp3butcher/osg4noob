    ...
    Rectangle {
        ...
        MouseArea {
            ...
            Column {
                y:170
                id: obj
                objectName: "osgParticle_EmitterQQQ"
                property var osgParticle_Emitter
                GroupBox {
                    anchors.fill: parent
               ...
               Grid{
                columns:2
                Label{
                    text:"useDefaultTemplate"

                }
                CheckBox{
                    checked: obj.osgParticle_Emitter.UseDefaultTemplate
                    onClicked: {
                     obj.osgParticle_Emitter.UseDefaultTemplate  = checked
                    }
