...
property var osgParticle_CenteredPlacer //QQModel


Rectangle{ color: "transparent"; height:20;width: 100;Label {text:"RadiusRange";font.pointSize: 14}}
    Rectangle{  color: "transparent"; height:20;width: 50;
    Grid{
    columns:3

    TextField{  width: 50;      text:classmain.osgParticle_CenteredPlacer.center.x.toFixed(3)
    onAccepted:classmain.osgParticle_CenteredPlacer.center.x=parseFloat(text)
    }
  TextField{  width: 50;      text:classmain.osgParticle_CenteredPlacer.center.y.toFixed(3)
    onAccepted:classmain.osgParticle_CenteredPlacer.center.y=parseFloat(text)
    }

    TextField{   width: 50;     text:classmain.osgParticle_CenteredPlacer.center.z.toFixed(3)
    onAccepted:classmain.osgParticle_CenteredPlacer.center.z=parseFloat(text)
    }
    }
