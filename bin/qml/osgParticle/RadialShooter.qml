...
/////////////////////////////////END CLASSIC//////////////////////////////////////////////
   ...
   GroupBox {
title:"RadialShooter Properties"
y:75
id:obj
objectName: "osgParticle_RadialShooterQQQ"
property var osgParticle_RadialShooter //QQModel
ColumnLayout{
RowLayout{Label {text:"Theta Range"}
TextField {text: obj.osgParticle_RadialShooter.minTheta.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.minTheta=parseFloat(text);}
TextField { text:obj.osgParticle_RadialShooter.maxTheta.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.maxTheta=parseFloat(text);}   }
RowLayout{Label {text:"maxPhi Range"}
TextField {text: obj.osgParticle_RadialShooter.minPhi.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.minPhi=parseFloat(text);}
TextField { text:obj.osgParticle_RadialShooter.maxPhi.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.maxPhi=parseFloat(text);}   }

RowLayout{Label {text:"InitialSpeed"}
TextField {text: obj.osgParticle_RadialShooter.minInitialSpeed.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.minInitialSpeed=parseFloat(text);}
TextField { text:obj.osgParticle_RadialShooter.maxInitialSpeed.toFixed(1);onAccepted:obj.osgParticle_RadialShooter.maxInitialSpeed=parseFloat(text);}   }
