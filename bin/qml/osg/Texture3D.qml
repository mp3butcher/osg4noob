            ...
            onClicked: if (mouse.button != Qt.RightButton)
                ...
                /////CLASSIC PART TO END
                    ...
                    Column {  ColorPicker {
                        ...
                        id:obj
                        objectName: "osg_Texture3DQQQ"
                        property var osg_Texture3D
                        ...
                        GroupBox {
                            ...
                            Grid {
                                ...
                                Button {
                                    ...
                                    onClicked: obj.osg_Texture3D.addToStateSet(
                                                   main.parent.qmodel)
                                }
                                Button {
                                    width: 160
                                    ...
                                    onClicked: {
                                       ...
                                       obj.osg_Texture3D.removeFromStateSet(
                                                    main.parent.qmodel);
parent=null;
                                ...
                                Rectangle {
                                    ...
                                    width: 160
                                    Label {
                                        text: obj.osg_Texture3D.filename
                                    }
                                }
                                ...
                                Button {
                                    ...
                                    FileDialog {
                                        ...
                                        onAccepted: {
                                            ...
                                            obj.osg_Texture3D.filename = fileDialog.fileUrls[0]
                                           //obj.osg_Texture3D.filename = fileDialog.fileUrls[0]
                                        }
                                        onRejected: {
                                ...
                                Image {
                                    ...
                                    width: 160
                                    height: 160
                                    source:obj.osg_Texture3D.qtimage
                                }
                                ...
                                Rectangle {
                                    ...
                                    width: 160
                                    TextField {
                                        text: obj.osg_Texture3D.wrap_t
                                        onTextChanged: obj.osg_Texture3D.wrap_t = text
                                    }
                                }
                                ...
                                Rectangle {
                                    ...
                                    width: 160
                                    TextField {
                                        text: obj.osg_Texture3D.wrap_s
                                        onTextChanged: obj.osg_Texture3D.wrap_s = text
                                    }
                                }
                                Rectangle {
                                    color: "transparent"
                                ...
                                Rectangle {
                                    color: obj.osg_Texture3D.bordercolor
                                    height: 20
                                    width: 160
                                    MouseArea {
                                        anchors.fill: parent
                               ...
                               TextField{
                                   text:obj.osg_Texture3D.TextureWidth
                                   onAccepted:obj.osg_Texture3D.TextureWidth=parseInt(text)
                                }
                               Rectangle {
                                   color: "transparent"
                                   height: 20
                              ...
                              TextField{
                                  text:obj.osg_Texture3D.TextureHeight
                                  onAccepted:obj.osg_Texture3D.TextureHeight=parseInt(text)
                               }
                                ...
                                Rectangle {
                                    ...
                                    width: 160
                                    TextField {
                                        text:obj.osg_Texture3D.borderwidth
                                        onTextChanged: obj.osg_Texture3D.borderwidth = parseInt(
                                                           text)
                                    }
                                }
                            }
