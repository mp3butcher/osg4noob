...
Column{
  ...
  //anchors.fill: parent
    y:75
    id: obj
    objectName: "osg_ScriptNodeCallbackQQQ"
   property var osg_ScriptNodeCallback

    Row{
        Label{text:"EntryPoint"}
        TextField{
            text:obj.osg_ScriptNodeCallback.EntryPoint
            onAccepted: obj.osg_ScriptNodeCallback.EntryPoint=text
        }
