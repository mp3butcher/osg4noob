...
#include "../../../../../media/xeul/20GIGADATA/SRC/osgCastWizard2/EditorGenerator2/osgQtOctreeFluid/QtToOSGView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QtToOSGView_t, stringdata) + ofs \
...
const QMetaObject QtToOSGView::staticMetaObject = {
    { &QQuickView::staticMetaObject, qt_meta_stringdata_QtToOSGView.data,
      qt_meta_data_QtToOSGView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtToOSGView.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QtQtToOSGView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject QtQtToOSGView::staticMetaObject = {
    { &QtToOSGView::staticMetaObject, qt_meta_stringdata_QtQtToOSGView.data,
      qt_meta_data_QtQtToOSGView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtQtToOSGView.stringdata))
