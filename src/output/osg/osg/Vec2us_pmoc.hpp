...
Vec2us * _model;
QReflect_Vec2us(const pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE  bool  operator!=(osg::QReflect_Vec2us &v)const;
Q_INVOKABLE  bool  operator<(osg::QReflect_Vec2us &v)const;
Q_INVOKABLE  bool  operator==(osg::QReflect_Vec2us &v)const;
Q_INVOKABLE void  set(osg::QReflect_Vec2us *rhs);
public slots:
