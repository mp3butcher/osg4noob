...
Vec3b * _model;
QReflect_Vec3b(const pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE  bool  operator!=(osg::QReflect_Vec3b &v)const;
Q_INVOKABLE  bool  operator<(osg::QReflect_Vec3b &v)const;
Q_INVOKABLE  bool  operator==(osg::QReflect_Vec3b &v)const;
Q_INVOKABLE void  set(osg::QReflect_Vec3b *rhs);
public slots:
