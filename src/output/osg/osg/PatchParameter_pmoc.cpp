...
///DefaultConstructor////////////////
osg::QReflect_PatchParameter::QReflect_PatchParameter(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::PatchParameter );           qRegisterMetaType<QMLPatchParameter>();
qmlRegisterType<QReflect_PatchParameter>("pmoc.osg",1,0,"QReflect_PatchParameter");
           qmlRegisterType<QMLPatchParameter>("pmoc.osg",1,0,"QMLPatchParameter");
};
...
QQModel* osg::MetaQReflect_PatchParameter::createQQModel(Instance*i){ //return new MetaQReflect_PatchParameter_QModel(i);}
