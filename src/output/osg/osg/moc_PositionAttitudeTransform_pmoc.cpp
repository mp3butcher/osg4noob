...
QT_MOC_LITERAL(3, 53, 27), // "asPositionAttitudeTransform"
QT_MOC_LITERAL(4, 81, 40), // "osg::QReflect_PositionAttitud..."
QT_MOC_LITERAL(5, 122, 11), // "setAttitude"
QT_MOC_LITERAL(6, 134, 19), // "osg::QReflect_Quat*"
QT_MOC_LITERAL(7, 154, 13), // "setPivotPoint"
QT_MOC_LITERAL(8, 168, 20), // "osg::QReflect_Vec3d*"
QT_MOC_LITERAL(9, 189, 11), // "setPosition"
QT_MOC_LITERAL(10, 201, 8) // "setScale"

    },
    "osg::QReflect_PositionAttitudeTransform\0"
    "updateModel\0\0asPositionAttitudeTransform\0"
    "osg::QReflect_PositionAttitudeTransform*\0"
...
void osg::QReflect_PositionAttitudeTransform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { osg::QReflect_PositionAttitudeTransform* _r = _t->asPositionAttitudeTransform();
            if (_a[0]) *reinterpret_cast< osg::QReflect_PositionAttitudeTransform**>(_a[0]) = _r; }  break;
        case 2: { osg::QReflect_PositionAttitudeTransform* _r = _t->asPositionAttitudeTransform();
            if (_a[0]) *reinterpret_cast< osg::QReflect_PositionAttitudeTransform**>(_a[0]) = _r; }  break;
        case 3: _t->setAttitude((*reinterpret_cast< osg::QReflect_Quat*(*)>(_a[1]))); break;
        case 4: _t->setPivotPoint((*reinterpret_cast< osg::QReflect_Vec3d*(*)>(_a[1]))); break;
        case 5: _t->setPosition((*reinterpret_cast< osg::QReflect_Vec3d*(*)>(_a[1]))); break;
        case 6: _t->setScale((*reinterpret_cast< osg::QReflect_Vec3d*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
