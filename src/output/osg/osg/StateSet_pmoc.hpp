...
// StateAttribute::GLModeValue  getMode( StateAttribute::GLMode );
// StateAttribute::GLModeValue  getTextureMode( unsigned int  , StateAttribute::GLMode );
...
// void  removeMode( StateAttribute::GLMode );
// void  removeTextureMode( unsigned int  , StateAttribute::GLMode );
...
// void  setMode( StateAttribute::GLMode  , StateAttribute::GLModeValue );
// void  setModeList( ModeList &);
// void  setTextureAttributeList( TextureAttributeList &);
// void  setTextureMode( unsigned int  , StateAttribute::GLMode  , StateAttribute::GLModeValue );
