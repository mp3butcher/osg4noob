...
///DefaultConstructor////////////////
osg::QReflect_Viewport::QReflect_Viewport(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Viewport );           qRegisterMetaType<QMLViewport>();
qmlRegisterType<QReflect_Viewport>("pmoc.osg",1,0,"QReflect_Viewport");
           qmlRegisterType<QMLViewport>("pmoc.osg",1,0,"QMLViewport");
};
...
QQModel* osg::MetaQReflect_Viewport::createQQModel(Instance*i){ //return new MetaQReflect_Viewport_QModel(i);}
