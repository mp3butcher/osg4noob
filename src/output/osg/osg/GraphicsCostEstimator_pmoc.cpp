...
///DefaultConstructor////////////////
osg::QReflect_ClampedLinearCostFunction1D::QReflect_ClampedLinearCostFunction1D(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::ClampedLinearCostFunction1D );           qRegisterMetaType<QMLClampedLinearCostFunction1D>();
qmlRegisterType<QReflect_ClampedLinearCostFunction1D>("pmoc.osg",1,0,"QReflect_ClampedLinearCostFunction1D");
           qmlRegisterType<QMLClampedLinearCostFunction1D>("pmoc.osg",1,0,"QMLClampedLinearCostFunction1D");
};
...
QQModel* osg::MetaQReflect_ClampedLinearCostFunction1D::createQQModel(Instance*i){ //return new MetaQReflect_ClampedLinearCostFunction1D_QModel(i);}
...
///DefaultConstructor////////////////
osg::QReflect_GeometryCostEstimator::QReflect_GeometryCostEstimator(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::GeometryCostEstimator );           qRegisterMetaType<QMLGeometryCostEstimator>();
qmlRegisterType<QReflect_GeometryCostEstimator>("pmoc.osg",1,0,"QReflect_GeometryCostEstimator");
           qmlRegisterType<QMLGeometryCostEstimator>("pmoc.osg",1,0,"QMLGeometryCostEstimator");
};
...
QQModel* osg::MetaQReflect_GeometryCostEstimator::createQQModel(Instance*i){ //return new MetaQReflect_GeometryCostEstimator_QModel(i);}
...
///DefaultConstructor////////////////
osg::QReflect_GraphicsCostEstimator::QReflect_GraphicsCostEstimator(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::GraphicsCostEstimator );           qRegisterMetaType<QMLGraphicsCostEstimator>();
qmlRegisterType<QReflect_GraphicsCostEstimator>("pmoc.osg",1,0,"QReflect_GraphicsCostEstimator");
           qmlRegisterType<QMLGraphicsCostEstimator>("pmoc.osg",1,0,"QMLGraphicsCostEstimator");
};
...
QQModel* osg::MetaQReflect_GraphicsCostEstimator::createQQModel(Instance*i){ //return new MetaQReflect_GraphicsCostEstimator_QModel(i);}
...
///DefaultConstructor////////////////
osg::QReflect_ProgramCostEstimator::QReflect_ProgramCostEstimator(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::ProgramCostEstimator );           qRegisterMetaType<QMLProgramCostEstimator>();
qmlRegisterType<QReflect_ProgramCostEstimator>("pmoc.osg",1,0,"QReflect_ProgramCostEstimator");
           qmlRegisterType<QMLProgramCostEstimator>("pmoc.osg",1,0,"QMLProgramCostEstimator");
};
...
QQModel* osg::MetaQReflect_ProgramCostEstimator::createQQModel(Instance*i){ //return new MetaQReflect_ProgramCostEstimator_QModel(i);}
...
///DefaultConstructor////////////////
osg::QReflect_TextureCostEstimator::QReflect_TextureCostEstimator(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::TextureCostEstimator );           qRegisterMetaType<QMLTextureCostEstimator>();
qmlRegisterType<QReflect_TextureCostEstimator>("pmoc.osg",1,0,"QReflect_TextureCostEstimator");
           qmlRegisterType<QMLTextureCostEstimator>("pmoc.osg",1,0,"QMLTextureCostEstimator");
};
...
QQModel* osg::MetaQReflect_TextureCostEstimator::createQQModel(Instance*i){ //return new MetaQReflect_TextureCostEstimator_QModel(i);}
