...
CullStack * _model;
QReflect_CullStack(pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE  bool  isCulled(osg::QReflect_Node *);
...
Q_INVOKABLE void  pushModelViewMatrix(osg::QReflect_RefMatrixd * ,osg::QReflect_Transform::ReferenceFrame );
Q_INVOKABLE void  pushProjectionMatrix(osg::QReflect_RefMatrixd *);
Q_INVOKABLE void  pushReferenceViewPoint(osg::QReflect_Vec3f *);
Q_INVOKABLE void  pushViewport(osg::QReflect_Viewport *);
