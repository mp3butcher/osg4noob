...
Vec3ub * _model;
QReflect_Vec3ub(const pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE  bool  operator!=(osg::QReflect_Vec3ub &v)const;
Q_INVOKABLE  bool  operator<(osg::QReflect_Vec3ub &v)const;
Q_INVOKABLE  bool  operator==(osg::QReflect_Vec3ub &v)const;
Q_INVOKABLE void  set(osg::QReflect_Vec3ub *rhs);
public slots:
