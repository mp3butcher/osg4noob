...
using namespace pmoc;
 bool  osg::QReflect_Vec3us:: operator!=(osg::QReflect_Vec3us  &p0)const{
//params checking
...
//params checking
if(! p0) {std::cerr<<"PMOC: osg::QReflect_Vec3us::set : parameter n.0 is NULL\n"<<endl;return;}
 _model->set(*p0->_model);

}

///DefaultConstructor////////////////
osg::QReflect_Vec3us::QReflect_Vec3us(const Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Vec3us );
           qRegisterMetaType<osg::QMLVec3us>();
           qRegisterMetaType<osg::QMLVec3us*>("pmoc.osg.QMLVec3us");
qmlRegisterType<osg::QReflect_Vec3us>("pmoc.osg",1,0,"QReflect_Vec3us");
           qmlRegisterType<osg::QMLVec3us>("pmoc.osg",1,0,"QMLVec3us");
};
...
QQModel* osg::MetaQReflect_Vec3us::createQQModel(const Instance*i){ //return new MetaQReflect_Vec3us_QModel(i);}
