...
///DefaultConstructor////////////////
osg::QReflect_TexGen::QReflect_TexGen(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::TexGen );           qRegisterMetaType<QMLTexGen>();
qmlRegisterType<QReflect_TexGen>("pmoc.osg",1,0,"QReflect_TexGen");
           qmlRegisterType<QMLTexGen>("pmoc.osg",1,0,"QMLTexGen");
};
...
QQModel* osg::MetaQReflect_TexGen::createQQModel(Instance*i){ //return new MetaQReflect_TexGen_QModel(i);}
