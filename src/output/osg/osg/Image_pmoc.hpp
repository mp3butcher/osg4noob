...
Q_INVOKABLE  GLenum  computeFormatDataType( GLenum );
Q_INVOKABLE  GLenum  computePixelFormat( GLenum );
...
Q_INVOKABLE  bool  isPackedType( GLenum );
...
Q_INVOKABLE  unsigned int  computeBlockSize( GLenum  , GLenum );
Q_INVOKABLE  unsigned int  computeImageSizeInBytes( int  , int  , int  , GLenum  , GLenum  , int  , int  , int );
Q_INVOKABLE  unsigned int  computeNumComponents( GLenum );
Q_INVOKABLE  unsigned int  computePixelSizeInBits( GLenum  , GLenum );
Q_INVOKABLE  unsigned int  computeRowWidthInBytes( int  , GLenum  , GLenum  , int );
...
Q_INVOKABLE void  allocateImage( int  , int  , int  , GLenum  , GLenum  , int );
...
Q_INVOKABLE void  readImageFromCurrentTexture( unsigned int  , bool  , GLenum  , unsigned int );
Q_INVOKABLE void  readPixels( int  , int  , int  , int  , GLenum  , GLenum  , int );
Q_INVOKABLE void  scaleImage( int  , int  , int  , GLenum );
...
Q_INVOKABLE void  setDataType( GLenum );
...
Q_INVOKABLE void  setPixelFormat( GLenum );
