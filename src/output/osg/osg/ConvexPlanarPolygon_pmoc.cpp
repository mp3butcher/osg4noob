...
///DefaultConstructor////////////////
osg::QReflect_ConvexPlanarPolygon::QReflect_ConvexPlanarPolygon(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::ConvexPlanarPolygon );           qRegisterMetaType<QMLConvexPlanarPolygon>();
qmlRegisterType<QReflect_ConvexPlanarPolygon>("pmoc.osg",1,0,"QReflect_ConvexPlanarPolygon");
           qmlRegisterType<QMLConvexPlanarPolygon>("pmoc.osg",1,0,"QMLConvexPlanarPolygon");
};
...
QQModel* osg::MetaQReflect_ConvexPlanarPolygon::createQQModel(Instance*i){ //return new MetaQReflect_ConvexPlanarPolygon_QModel(i);}
