...
QReflect_GraphicsOperation(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_EndOfDynamicDrawBlock(pmoc::Instance *i=0,QObject* parent=0);
virtual ~QReflect_EndOfDynamicDrawBlock( );
//EndOfDynamicDrawBlock
Q_INVOKABLE void  completed(osg::QReflect_State *);
public slots:
virtual void updateModel();
...
QReflect_BlockAndFlushOperation(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_SwapBuffersOperation(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_RunOperations(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_GraphicsThread(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_FlushDeletedGLObjectsOperation(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_BarrierOperation(pmoc::Instance *i=0,QObject* parent=0);
...
QReflect_ReleaseContext_Block_MakeCurrentOperation(pmoc::Instance *i=0,QObject* parent=0);
