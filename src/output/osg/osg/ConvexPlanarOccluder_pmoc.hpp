...
QReflect_ConvexPlanarOccluder(pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE void  addHole(osg::QReflect_ConvexPlanarPolygon *);
Q_INVOKABLE void  setOccluder(osg::QReflect_ConvexPlanarPolygon *);
public slots:
