...
///DefaultConstructor////////////////
osg::QReflect_Vec2d::QReflect_Vec2d(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Vec2d );           qRegisterMetaType<QMLVec2d>();
qmlRegisterType<QReflect_Vec2d>("pmoc.osg",1,0,"QReflect_Vec2d");
           qmlRegisterType<QMLVec2d>("pmoc.osg",1,0,"QMLVec2d");
};
...
QQModel* osg::MetaQReflect_Vec2d::createQQModel(Instance*i){ //return new MetaQReflect_Vec2d_QModel(i);}
