...
// bool  getFrustum( double & , double & , double & , double & , double & , double &);
// bool  getFrustum( float & , float & , float & , float & , float & , float &);
// bool  getOrtho( double & , double & , double & , double & , double & , double &);
// bool  getOrtho( float & , float & , float & , float & , float & , float &);
// bool  getPerspective( double & , double & , double & , double &);
// bool  getPerspective( float & , float & , float & , float &);
// bool  operator!=(const  Matrixf &);
// bool  operator<(const  Matrixf &);
// bool  operator==(const  Matrixf &);
// value_type  operator()( int  , int );
// value_type & operator()( int  , int );
// void  decompose( osg::Vec3d & , osg::Quat & , osg::Vec3d & , osg::Quat &);
// void  decompose( osg::Vec3f & , osg::Quat & , osg::Vec3f & , osg::Quat &);
// void  get( Quat &);
// void  getLookAt( Vec3d & , Vec3d & , Vec3d & , value_type );
// void  getLookAt( Vec3f & , Vec3f & , Vec3f & , value_type );
