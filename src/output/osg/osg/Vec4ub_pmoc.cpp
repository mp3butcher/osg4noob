...
using namespace pmoc;
 bool  osg::QReflect_Vec4ub:: operator!=(osg::QReflect_Vec4ub  &p0)const{
//params checking
...
///DefaultConstructor////////////////
osg::QReflect_Vec4ub::QReflect_Vec4ub(const Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Vec4ub );
           qRegisterMetaType<osg::QMLVec4ub>();
           qRegisterMetaType<osg::QMLVec4ub*>("pmoc.osg.QMLVec4ub");
qmlRegisterType<osg::QReflect_Vec4ub>("pmoc.osg",1,0,"QReflect_Vec4ub");
           qmlRegisterType<osg::QMLVec4ub>("pmoc.osg",1,0,"QMLVec4ub");
};
...
QQModel* osg::MetaQReflect_Vec4ub::createQQModel(const Instance*i){ //return new MetaQReflect_Vec4ub_QModel(i);}
