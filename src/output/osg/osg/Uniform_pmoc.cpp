...
const unsigned int osg::QReflect_Uniform::getModifiedCount()const{return _model->getModifiedCount();}
const unsigned int osg::QReflect_Uniform::getNumElements()const{return _model->getNumElements();}
...
void  osg::QReflect_Uniform::setModifiedCount(const unsigned int &par){_model->setModifiedCount(par);emit ModifiedCountChanged(par);}
void  osg::QReflect_Uniform::setNumElements(const unsigned int &par){_model->setNumElements(par);emit NumElementsChanged(par);}
void osg::QReflect_Uniform::pmoc_reverse_setEventCallback( osg::QReflect_UniformCallback *par){_model->setEventCallback(NULL);
emit EventCallbackChanged(NULL);
}
void osg::QReflect_Uniform::pmoc_reverse_setUpdateCallback( osg::QReflect_UniformCallback *par){_model->setUpdateCallback(NULL);
emit UpdateCallbackChanged(NULL);
}
void osg::QReflect_Uniform::setEventCallback( osg::QReflect_UniformCallback *par){_model->setEventCallback(par->_model);
emit EventCallbackChanged(par);
}
void osg::QReflect_Uniform::setUpdateCallback( osg::QReflect_UniformCallback *par){_model->setUpdateCallback(par->_model);
emit UpdateCallbackChanged(par);
}

///DefaultConstructor////////////////
osg::QReflect_Uniform::QReflect_Uniform(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Uniform );           qRegisterMetaType<QMLUniform>();
qmlRegisterType<QReflect_Uniform>("pmoc.osg",1,0,"QReflect_Uniform");
           qmlRegisterType<QMLUniform>("pmoc.osg",1,0,"QMLUniform");
...
QQModel* osg::MetaQReflect_Uniform::createQQModel(Instance*i){ //return new MetaQReflect_Uniform_QModel(i);}
