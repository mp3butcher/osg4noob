...
Vec2ub * _model;
QReflect_Vec2ub(const pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE  bool  operator!=(osg::QReflect_Vec2ub &v)const;
Q_INVOKABLE  bool  operator<(osg::QReflect_Vec2ub &v)const;
Q_INVOKABLE  bool  operator==(osg::QReflect_Vec2ub &v)const;
Q_INVOKABLE void  set(osg::QReflect_Vec2ub *rhs);
public slots:
