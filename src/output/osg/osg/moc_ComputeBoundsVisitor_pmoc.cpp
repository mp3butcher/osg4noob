...
QT_MOC_LITERAL(3, 48, 7), // "getBase"
QT_MOC_LITERAL(4, 56, 23), // "osg::QReflect_Polytope*"
QT_MOC_LITERAL(5, 80, 11), // "getPolytope"
QT_MOC_LITERAL(6, 92, 9), // "popMatrix"
QT_MOC_LITERAL(7, 102, 10), // "pushMatrix"
QT_MOC_LITERAL(8, 113, 22), // "osg::QReflect_Matrixd*"
QT_MOC_LITERAL(9, 136, 5) // "reset"

    },
    "osg::QReflect_ComputeBoundsVisitor\0"
    "updateModel\0\0getBase\0osg::QReflect_Polytope*\0"
    "getPolytope\0popMatrix\0pushMatrix\0"
    "osg::QReflect_Matrixd*\0reset"
};
...
void osg::QReflect_ComputeBoundsVisitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->getBase((*reinterpret_cast< osg::QReflect_Polytope*(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 2: _t->getPolytope((*reinterpret_cast< osg::QReflect_Polytope*(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 3: _t->popMatrix(); break;
        case 4: _t->pushMatrix((*reinterpret_cast< osg::QReflect_Matrixd*(*)>(_a[1]))); break;
