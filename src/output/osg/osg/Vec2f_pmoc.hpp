...
Vec2f * _model;
QReflect_Vec2f(pmoc::Instance *i=0,QObject* parent=0);
...
// bool  operator<(const  Vec2f &);
// bool  operator==(const  Vec2f &);
// value_type  operator*(const  Vec2f &);
...
Q_INVOKABLE void  set( float  , float );
Q_INVOKABLE void  set(osg::QReflect_Vec2f *);
public slots:
