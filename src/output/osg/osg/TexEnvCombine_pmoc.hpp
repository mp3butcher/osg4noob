...
//TexEnvCombine
// GLint  getCombine_Alpha();
// GLint  getCombine_RGB();
// GLint  getOperand0_Alpha();
// GLint  getOperand0_RGB();
// GLint  getOperand1_Alpha();
// GLint  getOperand1_RGB();
// GLint  getOperand2_Alpha();
// GLint  getOperand2_RGB();
// GLint  getSource0_Alpha();
// GLint  getSource0_RGB();
// GLint  getSource1_Alpha();
// GLint  getSource1_RGB();
// GLint  getSource2_Alpha();
// GLint  getSource2_RGB();
// Vec3  getConstantColorAsLightDirection();
//virtual  void  apply( State &);
// void  setCombine_Alpha( GLint );
// void  setCombine_RGB( GLint );
// void  setOperand0_Alpha( GLint );
// void  setOperand0_RGB( GLint );
// void  setOperand1_Alpha( GLint );
// void  setOperand1_RGB( GLint );
// void  setOperand2_Alpha( GLint );
// void  setOperand2_RGB( GLint );
// void  setSource0_Alpha( GLint );
// void  setSource0_RGB( GLint );
// void  setSource1_Alpha( GLint );
// void  setSource1_RGB( GLint );
// void  setSource2_Alpha( GLint );
// void  setSource2_RGB( GLint );
