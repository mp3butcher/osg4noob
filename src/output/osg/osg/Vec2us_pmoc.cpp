...
///DefaultConstructor////////////////
osg::QReflect_Vec2us::QReflect_Vec2us(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osg::Vec2us );           qRegisterMetaType<QMLVec2us>();
qmlRegisterType<QReflect_Vec2us>("pmoc.osg",1,0,"QReflect_Vec2us");
           qmlRegisterType<QMLVec2us>("pmoc.osg",1,0,"QMLVec2us");
};
...
QQModel* osg::MetaQReflect_Vec2us::createQQModel(Instance*i){ //return new MetaQReflect_Vec2us_QModel(i);}
