...
Q_INVOKABLE  bool  applyMode( GLenum  , bool );
Q_INVOKABLE  bool  applyTextureAttribute( unsigned int  ,osg::QReflect_StateAttribute *);
Q_INVOKABLE  bool  applyTextureMode( unsigned int  , GLenum  , bool );
Q_INVOKABLE  bool  checkGLErrors( GLenum )const;
...
Q_INVOKABLE  bool  getGlobalDefaultModeValue( GLenum );
Q_INVOKABLE  bool  getGlobalDefaultTextureModeValue( unsigned int  , GLenum );
Q_INVOKABLE  bool  getLastAppliedMode( GLenum )const;
Q_INVOKABLE  bool  getLastAppliedTextureMode( unsigned int  , GLenum )const;
Q_INVOKABLE  bool  getModeValidity( GLenum );
...
Q_INVOKABLE void  drawQuads( GLint  , GLsizei  , GLsizei );
Q_INVOKABLE void  frameCompleted();
Q_INVOKABLE void  glDrawArraysInstanced( GLenum  , GLint  , GLsizei  , GLsizei );
Q_INVOKABLE void  glDrawElementsInstanced( GLenum  , GLsizei  , GLenum  ,const  GLvoid * , GLsizei );
...
Q_INVOKABLE void  haveAppliedMode( GLenum  , unsigned int );
Q_INVOKABLE void  haveAppliedMode( GLenum );
...
Q_INVOKABLE void  haveAppliedTextureMode( unsigned int  , GLenum  , unsigned int );
Q_INVOKABLE void  haveAppliedTextureMode( unsigned int  , GLenum );
...
Q_INVOKABLE void  setColorPointer( GLint  , GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
...
Q_INVOKABLE void  setFogCoordPointer( GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
...
Q_INVOKABLE void  setGlobalDefaultModeValue( GLenum  , bool );
Q_INVOKABLE void  setGlobalDefaultTextureAttribute( unsigned int  ,osg::QReflect_StateAttribute *);
Q_INVOKABLE void  setGlobalDefaultTextureModeValue( unsigned int  , GLenum  , bool );
Q_INVOKABLE void  setInitialViewMatrix(osg::QReflect_RefMatrixd *);
Q_INVOKABLE void  setInterleavedArrays( GLenum  , GLsizei  ,const  GLvoid *);
Q_INVOKABLE void  setModeValidity( GLenum  , bool );
Q_INVOKABLE void  setNormalAlias(osg::QReflect_VertexAttribAlias *);
Q_INVOKABLE void  setNormalPointer( GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
...
Q_INVOKABLE void  setSecondaryColorPointer( GLint  , GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
Q_INVOKABLE void  setSecondaryColorPointer(osg::QReflect_Array *);
Q_INVOKABLE void  setTexCoordPointer( unsigned int  , GLint  , GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
...
Q_INVOKABLE void  setVertexAttribIPointer( unsigned int  , GLint  , GLenum  , GLsizei  ,const  GLvoid *);
Q_INVOKABLE void  setVertexAttribIPointer( unsigned int  ,osg::QReflect_Array *);
Q_INVOKABLE void  setVertexAttribLPointer( unsigned int  , GLint  , GLenum  , GLsizei  ,const  GLvoid *);
Q_INVOKABLE void  setVertexAttribLPointer( unsigned int  ,osg::QReflect_Array *);
Q_INVOKABLE void  setVertexAttribPointer( unsigned int  , GLint  , GLenum  , GLboolean  , GLsizei  ,const  GLvoid *);
Q_INVOKABLE void  setVertexAttribPointer( unsigned int  ,osg::QReflect_Array *);
Q_INVOKABLE void  setVertexPointer( GLint  , GLenum  , GLsizei  ,const  GLvoid * , GLboolean );
