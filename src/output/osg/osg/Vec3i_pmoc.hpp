...
Vec3i * _model;
QReflect_Vec3i(const pmoc::Instance *i=0,QObject* parent=0);
...
// Vec3i  operator-(const  Vec3i &);
// Vec3i  operator/( value_type );
Q_INVOKABLE  bool  operator!=(osg::QReflect_Vec3i &v)const;
Q_INVOKABLE  bool  operator<(osg::QReflect_Vec3i &v)const;
Q_INVOKABLE  bool  operator==(osg::QReflect_Vec3i &v)const;
...
Q_INVOKABLE void  set( int r , int g , int b);
Q_INVOKABLE void  set(osg::QReflect_Vec3i *rhs);
public slots:
