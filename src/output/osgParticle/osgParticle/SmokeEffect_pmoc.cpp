...
///DefaultConstructor////////////////
osgParticle::QReflect_SmokeEffect::QReflect_SmokeEffect(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osgParticle::SmokeEffect );           qRegisterMetaType<QMLSmokeEffect>();
qmlRegisterType<QReflect_SmokeEffect>("pmoc.osgParticle",1,0,"QReflect_SmokeEffect");
           qmlRegisterType<QMLSmokeEffect>("pmoc.osgParticle",1,0,"QMLSmokeEffect");
};
...
QQModel* osgParticle::MetaQReflect_SmokeEffect::createQQModel(Instance*i){ //return new MetaQReflect_SmokeEffect_QModel(i);}
