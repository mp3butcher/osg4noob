...
QReflect_CenteredPlacer(const pmoc::Instance *i=0,QObject* parent=0);
...
Q_INVOKABLE void  setCenter( float x , float y , float z);
Q_INVOKABLE void  setCenter(osg::QReflect_Vec3f *v);
public slots:
