...
///DefaultConstructor////////////////
osgParticle::QReflect_Program::QReflect_Program(Instance *i,QObject* parent):QQModel(i,parent),_model(0){
...
_typeid=&typeid(osgParticle::Program );           qRegisterMetaType<QMLProgram>();
qmlRegisterType<QReflect_Program>("pmoc.osgParticle",1,0,"QReflect_Program");
           qmlRegisterType<QMLProgram>("pmoc.osgParticle",1,0,"QMLProgram");
};
...
QQModel* osgParticle::MetaQReflect_Program::createQQModel(Instance*i){ //return new MetaQReflect_Program_QModel(i);}
