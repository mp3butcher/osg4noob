...
#include "pluginModule_QQQosgParticle_Library.h"
using namespace pmoc;
REGISTER_METAQQUICKLIBRARY(pluginModule_QQQosgParticle_Library_QMLLibrary);
 pluginModule_QQQosgParticle_Library_QMLLibrary::pluginModule_QQQosgParticle_Library_QMLLibrary():MetaQQuickLibrary("pluginModule_QQQosgParticle_Library"){
...
pluginModule_QQQosgParticle_Library_QMLLibrary::~pluginModule_QQQosgParticle_Library_QMLLibrary(){}
	///setup metaclass children and parents (require dependancies to be loaded)
 void pluginModule_QQQosgParticle_Library_QMLLibrary::setupRelations() {MetaQQuickLibraryRegistry::instance()->getMetaClassByID("osgParticle::AccelOperator")->addParent(MetaQQuickLibraryRegistry::instance()->getMetaClassByID("osgParticle::Operator")); 
...
MetaQQuickLibraryRegistry::instance()->getMetaClassByID("osgParticle::VariableRateCounter")->addParent(MetaQQuickLibraryRegistry::instance()->getMetaClassByID("osgParticle::Counter")); 
 ...
 #ifndef AUTOMOCCPP
#define AUTOMOCCPP 1
#include "moc_pluginModule_QQQosgParticle_Library.cpp"
#endif
