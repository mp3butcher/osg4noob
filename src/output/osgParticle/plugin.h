#ifndef GLOBAL_CPP_CONTEXT_osgParticleH
#define GLOBAL_CPP_CONTEXT_osgParticleH 
...
namespace pmoc{
	class osgParticle_QMLLibrary: public MetaQQuickLibrary{
	private:
 public:
