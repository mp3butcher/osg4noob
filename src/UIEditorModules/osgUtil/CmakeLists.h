...
ADD_DEFINTIONS(-DQQUICK_LIBRARY_osgUtil_LIBRARY )
set(PATHTOHEADER ${PROJECT_SOURCE_DIR }/../src/ )
	INCLUDE_directories(${PATHTOHEADER })
			SET(SOURCES_CPP 
osgUtil_MetaQQuickLib.cpp
...
SET_TARGET_PROPERTIES(${PROJECT_NAME} PROPERTIES PROJECT_LABEL "Module UIEditor_osgUtil"  COMPILE_FLAGS -std=c++11 )
